...
### Changed
- **Random mode skips the last 10 exams within 14 days** (was 5 / 10). `RECENT_EXAMS_N=10`, `RECENT_EXAMS_DAYS=14` in `data/app-template.html`; mode card and config note interpolate both.
